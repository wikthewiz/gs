...
/**
 * Manual modifications go to {org.arccore.gdbsl.ui.GdbslUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractGdbslUiModule extends DefaultUiModule {
	
	public AbstractGdbslUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(org.arccore.gdbsl.parser.antlr.internal.InternalGdbslLexer.class);
	}
