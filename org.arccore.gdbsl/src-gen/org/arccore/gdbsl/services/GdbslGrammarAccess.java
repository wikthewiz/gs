...
package org.arccore.gdbsl.services;
...
@Singleton
public class GdbslGrammarAccess extends AbstractGrammarElementFinder {
	...
	@Inject
	public GdbslGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.arccore.gdbsl.Gdbsl".equals(grammar.getName())) {
				return grammar;
			}
