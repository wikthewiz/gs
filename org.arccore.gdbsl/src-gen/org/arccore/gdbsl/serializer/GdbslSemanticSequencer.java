package org.arccore.gdbsl.serializer;
...
public class GdbslSemanticSequencer extends XbaseSemanticSequencer {

	@Inject
	private GdbslGrammarAccess grammarAccess;
	
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == GdbslPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case GdbslPackage.IMPORT:
				if(context == grammarAccess.getImportRule()) {
					sequence_Import(context, (Import) semanticObject); 
					return; 
				}
				else break;
			case GdbslPackage.SCRIPT:
	...
	protected void sequence_Import(EObject context, Import semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, GdbslPackage.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GdbslPackage.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
