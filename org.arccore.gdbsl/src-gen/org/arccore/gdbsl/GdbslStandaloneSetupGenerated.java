...
public class GdbslStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.arccore.gdbsl.GdbslRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.arccore.org/gdbsl/Gdbsl")) {
		EPackage.Registry.INSTANCE.put("http://www.arccore.org/gdbsl/Gdbsl", org.arccore.gdbsl.gdbsl.GdbslPackage.eINSTANCE);
	}
